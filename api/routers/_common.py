...
from config import CLICKHOUSE_CONN_STR
...
def require_role(claims: Dict[str, Any], expected_role: str) -> None:
...
def get_clickhouse_client() -> ClickHouseClient:
    parsed = urlparse(CLICKHOUSE_CONN_STR)
...
def query_ch(query: str, params: Optional[Dict[str, Any]] = None) -> list[Dict[str, Any]]:
