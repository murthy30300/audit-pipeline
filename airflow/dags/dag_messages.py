"""Messages ETL DAG: PostgreSQL -> ClickHouse bronze layer"""
...
# Fixed: use actual column names from the messages table
REQUIRED_COLUMNS = ["message_id", "customer_id", "message_type", "sent_at", "updated_at"]
