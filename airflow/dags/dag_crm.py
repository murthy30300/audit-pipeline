"""CRM ETL DAG: PostgreSQL -> ClickHouse bronze layer"""
...
# Fixed: use actual column names from the crm table
REQUIRED_COLUMNS = ["crm_id", "customer_id", "interaction_type", "updated_at"]
COERCION_RULES   = [{"kind": "str", "field": "crm_id"}]
