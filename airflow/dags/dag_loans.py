...
def get_watermark(**_kwargs) -> str:
    """Retrieve watermark for incremental loading"""
...
def extract_from_postgres(**kwargs):
    """Extract rows from PostgreSQL since last watermark"""
...
def validate_extract(**kwargs) -> bool:
    """Validate extracted data for schema and data types"""
    ti = kwargs["ti"]
...
def load_to_bronze(**kwargs):
    """Load extracted rows into ClickHouse bronze table"""
...
def update_watermark(**kwargs):
    """Update watermark for next incremental load"""
